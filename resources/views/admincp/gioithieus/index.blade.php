...
@section('title', 'Admincp | Giới thiệu')
@push('main') Trang chủ @endpush
@push('item') Giới thiệu @endpush
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary" href="admincp/gioithieus/create"><i class="fas fa-plus"> </i> Tạo giới thiệu</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($gioithieu as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admincp/gioithieus/edit/{{$item->id}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="@lang('admin.update_info')">
...
@push('scripts')
    ...
    <script>
        status('admincp/gioithieus');
        destroy('admincp/gioithieus');
    </script>
@endpush
