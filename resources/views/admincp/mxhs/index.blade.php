...
@section('title', 'Admincp | Mạng xã hội')
@push('main') Trang chủ @endpush
@push('item') Mạng xã hội @endpush
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary" href="admincp/mxhs/create"><i class="fas fa-plus"> </i> Tạo mạng xã hội</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($mxh as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admincp/mxhs/edit/{{$item->id}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="@lang('admin.update_info')">
