...
@section('title', 'Admincp | Chỉnh sửa Tin tức')
@push('main') Tin tức @endpush
@push('tintuc') {{__('admin.edit')}} @endpush
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="admincp/tintucs/{{$tintuc->id}}/update" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="card card-primary card-outline">
                                ...
                                <div class="row ml-0">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" name="ten" value="{{ $tintuc->ten }}" class="form-control" placeholder="Nhập tên" />
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label> Slug </label>
                                        <input type="text" name="slug" value="{{ $tintuc->slug }}" class="form-control" placeholder="Nhập slug" />
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label> Tiêu đề JP </label>
                                        <input type="text" name="tenjp" value="{{ $tintuc->tenjp }}" class="form-control" placeholder="Nhập tên JP" />
                                    </div>
                                    <div class="form_group col-lg-6">
                                        <label> Mô tả TV</label>
                                        <textarea name="description" class="form-control" cols="30" rows="3">{!!$tintuc->description!!}</textarea>
                                    </div>
                                    <div class="form_group col-lg-6">
                                        <label> Mô tả JP</label>
                                        <textarea name="descriptionjp" class="form-control" cols="30" rows="3">{!!$tintuc->descriptionjp!!}</textarea>
                                    </div>
                                    <div class="form_group col-lg-6">
                                    ...
                                    <div class="card-body col-lg-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control d-none" type="text" name="image" value="{{$tintuc->image}}">
                                            </div>
                                            <div id="holder">
                                                <img src="{{$tintuc->image}}" style="height: 10rem;">
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <label> {{__('admin.status')}}</label>
                                            <input type="checkbox" name="status" @if ($tintuc->stt == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                        </div>
                                    </div>
                                </div>
                            </div>
