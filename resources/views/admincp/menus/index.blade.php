...
@section('title', 'Admincp | Menu')
@push('main') Trang chủ @endpush
@push('item') Menu @endpush
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary" href="admincp/menus/create"><i class="fas fa-plus"> </i> Tạo menu</a>
                                </div>
                            </div>
                            <div class="card-body">
...
@push('scripts')
    ...
    <script>
        status('admincp/menus');
        destroy('admincp/menus');
    </script>
@endpush
