...
@section('title', 'Admincp | Chỉnh sửa banner')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="admincp/banners/{{$banner->id}}/update" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card-body col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control d-none" type="text" name="image" value="{{$banner->image}}">
                                            </div>
                                            <div id="holder">
                                                <img src="{{$banner->image}}" style="height: 10rem;">
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <label> {{__('admin.status')}}</label>
                                            <input type="checkbox" name="status" @if ($banner->stt == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                        </div>
                                    </div>
                                </div>
                            </div>
