...
@section('title', 'Admincp | Chỉnh sửa cảm nhận')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="admincp/camnhans/{{$camnhan->id}}/update" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="card card-primary card-outline">
                                ...
                                <div class="row ml-0">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" name="tenhocvien" value="{{ $camnhan->tenhocvien }}" class="form-control" placeholder="Nhập tên học viên" />
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label> Ngành nghề </label>
                                        <input type="text" name="nganhnghe" value="{{ $camnhan->nganhnghe }}" class="form-control" placeholder="Nhập ngành nghề" />
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label> Ngành nghề JP</label>
                                        <input type="text" name="nganhnghejp" value="{{ $camnhan->nganhnghejp }}" class="form-control" placeholder="Nhập ngành nghề JP" />
                                    </div>
                                    <div class="form_group col-lg-6">
                                        <label> Nội dung TV</label>
                                        <textarea name="noidung" class="form-control" cols="30" rows="10">{!!$camnhan->noidung!!}</textarea>
                                    </div>
                                    <div class="form_group col-lg-6">
                                        <label> Nội dung JP</label>
                                        <textarea name="noidungjp" class="form-control" cols="30" rows="10">{!!$camnhan->noidungjp!!}</textarea>
                                    </div>
                                    <div class="card-body col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="ngayxuatcanh" value="{{datevn($camnhan->ngayxuatcanh)}}" class="form-control datemask" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control d-none" type="text" name="image" value="{{$camnhan->image}}">
                                            </div>
                                            <div id="holder">
                                                <img src="{{$camnhan->image}}" style="height: 10rem;">
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <label> {{__('admin.status')}}</label>
                                            <input type="checkbox" name="status" @if ($camnhan->stt == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="primary">
                                        </div>
                                    </div>
                                </div>
                            </div>
