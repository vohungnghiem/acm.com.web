...
@section('title', 'Admincp | Mục tiêu')
@push('main') Trang chủ @endpush
@push('item') Mục tiêu @endpush
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary" href="admincp/muctieus/create"><i class="fas fa-plus"> </i> Tạo mục tiêu</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($muctieu as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admincp/muctieus/edit/{{$item->id}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="@lang('admin.update_info')">
...
@push('scripts')
    ...
    <script>
        status('admincp/muctieus');
        destroy('admincp/muctieus');
    </script>
@endpush
