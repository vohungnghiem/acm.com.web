...
@section('title', 'Admincp | Hồ sơ')
@push('main') Trang chủ @endpush
@push('item') Hồ sơ @endpush
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-primary" href="admincp/hosos/create"><i class="fas fa-plus"> </i> Tạo hồ sơ</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        @foreach ($hoso as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admincp/hosos/edit/{{$item->id}}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="@lang('admin.update_info')">
...
@push('scripts')
    ...
    <script>
        status('admincp/hosos');
        destroy('admincp/hosos');
    </script>
@endpush
