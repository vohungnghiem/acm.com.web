    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate text-center fadeInUp ftco-animated">
                <p class="breadcrumbs"><span class="mr-2"><a href="/">Trang chủ</a></span> <span>ĐIỀU DƯỠNG</span></p>
                <h1 class="mb-3 bread">ĐIỀU DƯỠNG</h1>
            </div>
        </div>
    </div>
</div>
<section class="ftco-section">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <h2 class="mb-3">TIN TỨC ĐIỀU DƯỠNG NỔI BẬT</h2>
                    ...
                    <div class="col-md-4 d-flex ftco-animate fadeInUp ftco-animated">
                        <div class="blog-entry align-self-stretch">
                            ...
                            <div class="text p-4 d-block">
                                ...
                                <h5 class="heading mt-3"><a href="tintuc/{{ $item->slug }}">{{$item->ten}}</a></h5>
